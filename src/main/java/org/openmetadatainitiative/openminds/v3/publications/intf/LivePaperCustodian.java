 ...
 */
public interface LivePaperCustodian extends Entity {
   Reference<? extends LivePaperCustodian> getReference();

   class Deserializer extends ByTypeDeserializer<LivePaperCustodian> {
        public Deserializer() {
