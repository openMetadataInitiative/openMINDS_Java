...
public interface LearningResourceAuthor extends Entity {
   Reference<? extends LearningResourceAuthor> getReference();

   class Deserializer extends ByTypeDeserializer<LearningResourceAuthor> {
        public Deserializer() {
