...
import static org.openmetadatainitiative.openminds.v3.controlledTerms.StimulationTechnique.*;
/**
 * 
 *
...
public class StimulationTechnique extends Instance implements org.openmetadatainitiative.openminds.v3.computation.intf.WorkflowRecipeVersionKeyword, org.openmetadatainitiative.openminds.v3.computation.intf.ValidationTestVersionKeyword, org.openmetadatainitiative.openminds.v3.publications.intf.LearningResourceKeyword, org.openmetadatainitiative.openminds.v3.publications.intf.ChapterKeyword, org.openmetadatainitiative.openminds.v3.publications.intf.ScholarlyArticleKeyword, org.openmetadatainitiative.openminds.v3.publications.intf.LivePaperVersionKeyword, org.openmetadatainitiative.openminds.v3.publications.intf.BookKeyword, org.openmetadatainitiative.openminds.v3.SANDS.atlas.intf.BrainAtlasVersionKeyword, org.openmetadatainitiative.openminds.v3.SANDS.atlas.intf.CommonCoordinateSpaceVersionKeyword, org.openmetadatainitiative.openminds.v3.core.research.intf.BehavioralProtocolStimulation, org.openmetadatainitiative.openminds.v3.core.research.intf.ProtocolTechnique, org.openmetadatainitiative.openminds.v3.core.research.intf.CustomPropertySetRelevantFor, org.openmetadatainitiative.openminds.v3.core.products.intf.SoftwareVersionKeyword, org.openmetadatainitiative.openminds.v3.core.products.intf.WebServiceVersionKeyword, org.openmetadatainitiative.openminds.v3.core.products.intf.ModelVersionKeyword, org.openmetadatainitiative.openminds.v3.core.products.intf.MetaDataModelVersionKeyword, org.openmetadatainitiative.openminds.v3.core.products.intf.DatasetVersionKeyword, org.openmetadatainitiative.openminds.v3.core.products.intf.DatasetVersionTechnique, org.openmetadatainitiative.openminds.v3.core.data.intf.FileBundleGroupedBy{
    ...
    public static Reference<StimulationTechnique> createReference(InstanceId instanceId) {
    ...
    public class Builder implements org.openmetadatainitiative.openminds.utils.Builder<StimulationTechnique>{
        ...
        public StimulationTechnique build() {
            if (StimulationTechnique.this.id == null) {
                StimulationTechnique.this.id = new InstanceId(UUID.randomUUID().toString());
            }
            if(StimulationTechnique.this.types == null || StimulationTechnique.this.types.isEmpty() || !StimulationTechnique.this.types.contains(SEMANTIC_NAME)){
                final List<String> oldValues = StimulationTechnique.this.types;
                StimulationTechnique.this.types = new ArrayList<>();
                StimulationTechnique.this.types.add(SEMANTIC_NAME);
                if(oldValues != null){
                    StimulationTechnique.this.types.addAll(oldValues);
                }
            }
