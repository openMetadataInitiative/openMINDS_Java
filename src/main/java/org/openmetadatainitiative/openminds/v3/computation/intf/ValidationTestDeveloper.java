 ...
 */
public interface ValidationTestDeveloper extends Entity {
   Reference<? extends ValidationTestDeveloper> getReference();

   class Deserializer extends ByTypeDeserializer<ValidationTestDeveloper> {
        public Deserializer() {
