...
public interface ModelCustodian extends Entity {
   Reference<? extends ModelCustodian> getReference();

   class Deserializer extends ByTypeDeserializer<ModelCustodian> {
        public Deserializer() {
