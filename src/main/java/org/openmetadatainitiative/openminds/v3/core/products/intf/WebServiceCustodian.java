...
public interface WebServiceCustodian extends Entity {
   Reference<? extends WebServiceCustodian> getReference();

   class Deserializer extends ByTypeDeserializer<WebServiceCustodian> {
        public Deserializer() {
