...
public interface SubjectStateWeight extends Entity {
   Reference<? extends SubjectStateWeight> getReference();

   class Deserializer extends ByTypeDeserializer<SubjectStateWeight> {
        public Deserializer() {
    ...
    static SubjectStateWeight.EmbeddedBuilder createEmbedded(){
