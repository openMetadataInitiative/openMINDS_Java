...
public interface MetaDataModelVersionDeveloper extends Entity {
   Reference<? extends MetaDataModelVersionDeveloper> getReference();

   class Deserializer extends ByTypeDeserializer<MetaDataModelVersionDeveloper> {
        public Deserializer() {
