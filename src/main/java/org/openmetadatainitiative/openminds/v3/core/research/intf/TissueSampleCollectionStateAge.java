...
public interface TissueSampleCollectionStateAge extends Entity {
   Reference<? extends TissueSampleCollectionStateAge> getReference();

   class Deserializer extends ByTypeDeserializer<TissueSampleCollectionStateAge> {
        public Deserializer() {
    ...
    static TissueSampleCollectionStateAge.EmbeddedBuilder createEmbedded(){
