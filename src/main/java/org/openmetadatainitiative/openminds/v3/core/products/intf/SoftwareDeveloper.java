...
public interface SoftwareDeveloper extends Entity {
   Reference<? extends SoftwareDeveloper> getReference();

   class Deserializer extends ByTypeDeserializer<SoftwareDeveloper> {
        public Deserializer() {
