...
public interface ModelDeveloper extends Entity {
   Reference<? extends ModelDeveloper> getReference();

   class Deserializer extends ByTypeDeserializer<ModelDeveloper> {
        public Deserializer() {
