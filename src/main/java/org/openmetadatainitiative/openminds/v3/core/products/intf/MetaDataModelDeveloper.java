 ...
 */
public interface MetaDataModelDeveloper extends Entity {
   Reference<? extends MetaDataModelDeveloper> getReference();

   class Deserializer extends ByTypeDeserializer<MetaDataModelDeveloper> {
        public Deserializer() {
