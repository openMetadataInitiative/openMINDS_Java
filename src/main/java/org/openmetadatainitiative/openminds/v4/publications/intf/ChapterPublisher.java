...
public interface ChapterPublisher extends Entity {
   Reference<? extends ChapterPublisher> getReference();

   class Deserializer extends ByTypeDeserializer<ChapterPublisher> {
        public Deserializer() {
