...
public interface LivePaperVersionAuthor extends Entity {
   Reference<? extends LivePaperVersionAuthor> getReference();

   class Deserializer extends ByTypeDeserializer<LivePaperVersionAuthor> {
        public Deserializer() {
