...
public interface LivePaperAuthor extends Entity {
   Reference<? extends LivePaperAuthor> getReference();

   class Deserializer extends ByTypeDeserializer<LivePaperAuthor> {
        public Deserializer() {
