...
public interface ChapterCustodian extends Entity {
   Reference<? extends ChapterCustodian> getReference();

   class Deserializer extends ByTypeDeserializer<ChapterCustodian> {
        public Deserializer() {
