...
public interface WorkflowRecipeVersionDeveloper extends Entity {
   Reference<? extends WorkflowRecipeVersionDeveloper> getReference();

   class Deserializer extends ByTypeDeserializer<WorkflowRecipeVersionDeveloper> {
        public Deserializer() {
