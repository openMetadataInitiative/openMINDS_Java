...
public interface CommonCoordinateSpaceVersionRelatedPublication extends Entity {
   Reference<? extends CommonCoordinateSpaceVersionRelatedPublication> getReference();

   class Deserializer extends ByTypeDeserializer<CommonCoordinateSpaceVersionRelatedPublication> {
        public Deserializer() {
