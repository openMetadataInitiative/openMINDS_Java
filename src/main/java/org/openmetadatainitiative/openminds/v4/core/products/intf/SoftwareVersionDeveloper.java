...
public interface SoftwareVersionDeveloper extends Entity {
   Reference<? extends SoftwareVersionDeveloper> getReference();

   class Deserializer extends ByTypeDeserializer<SoftwareVersionDeveloper> {
        public Deserializer() {
