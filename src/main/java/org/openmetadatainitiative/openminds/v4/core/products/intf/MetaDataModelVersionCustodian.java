...
public interface MetaDataModelVersionCustodian extends Entity {
   Reference<? extends MetaDataModelVersionCustodian> getReference();

   class Deserializer extends ByTypeDeserializer<MetaDataModelVersionCustodian> {
        public Deserializer() {
