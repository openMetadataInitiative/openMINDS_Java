...
public interface DatasetCustodian extends Entity {
   Reference<? extends DatasetCustodian> getReference();

   class Deserializer extends ByTypeDeserializer<DatasetCustodian> {
        public Deserializer() {
