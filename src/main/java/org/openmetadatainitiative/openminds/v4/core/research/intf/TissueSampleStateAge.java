...
public interface TissueSampleStateAge extends Entity {
   Reference<? extends TissueSampleStateAge> getReference();

   class Deserializer extends ByTypeDeserializer<TissueSampleStateAge> {
        public Deserializer() {
    ...
    static TissueSampleStateAge.EmbeddedBuilder createEmbedded(){
