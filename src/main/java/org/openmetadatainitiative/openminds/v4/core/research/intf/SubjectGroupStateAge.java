...
public interface SubjectGroupStateAge extends Entity {
   Reference<? extends SubjectGroupStateAge> getReference();

   class Deserializer extends ByTypeDeserializer<SubjectGroupStateAge> {
        public Deserializer() {
    ...
    static SubjectGroupStateAge.EmbeddedBuilder createEmbedded(){
