...
public interface SoftwareVersionCustodian extends Entity {
   Reference<? extends SoftwareVersionCustodian> getReference();

   class Deserializer extends ByTypeDeserializer<SoftwareVersionCustodian> {
        public Deserializer() {
