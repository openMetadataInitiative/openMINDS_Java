...
public interface WebServiceVersionDeveloper extends Entity {
   Reference<? extends WebServiceVersionDeveloper> getReference();

   class Deserializer extends ByTypeDeserializer<WebServiceVersionDeveloper> {
        public Deserializer() {
