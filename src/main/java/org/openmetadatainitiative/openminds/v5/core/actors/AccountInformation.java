...
import static org.openmetadatainitiative.openminds.v5.core.actors.AccountInformation.SEMANTIC_NAME;
/**
...
public class AccountInformation extends Instance implements org.openmetadatainitiative.openminds.OpenMINDS.V5.Entity{
    ...
    public class Builder implements org.openmetadatainitiative.openminds.utils.Builder<AccountInformation>{
        ...
        public AccountInformation build(OpenMINDSContext context) {
            AccountInformation.super.build(context);
