...
public interface SubjectStateAge extends Entity {
   Reference<? extends SubjectStateAge> getReference();

   class Deserializer extends ByTypeDeserializer<SubjectStateAge> {
        public Deserializer() {
    ...
    static SubjectStateAge.EmbeddedBuilder createEmbedded(){
