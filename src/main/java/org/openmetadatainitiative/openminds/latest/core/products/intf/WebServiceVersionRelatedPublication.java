 ...
 */
public interface WebServiceVersionRelatedPublication extends Entity {
   Reference<? extends WebServiceVersionRelatedPublication> getReference();

   class Deserializer extends ByTypeDeserializer<WebServiceVersionRelatedPublication> {
        public Deserializer() {
