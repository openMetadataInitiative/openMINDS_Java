 ...
 */
public interface MetaDataModelCustodian extends Entity {
   Reference<? extends MetaDataModelCustodian> getReference();

   class Deserializer extends ByTypeDeserializer<MetaDataModelCustodian> {
        public Deserializer() {
