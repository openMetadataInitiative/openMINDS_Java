 ...
 */
public interface SoftwareCustodian extends Entity {
   Reference<? extends SoftwareCustodian> getReference();

   class Deserializer extends ByTypeDeserializer<SoftwareCustodian> {
        public Deserializer() {
