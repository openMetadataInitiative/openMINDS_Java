 ...
 */
public interface DatasetVersionCustodian extends Entity {
   Reference<? extends DatasetVersionCustodian> getReference();

   class Deserializer extends ByTypeDeserializer<DatasetVersionCustodian> {
        public Deserializer() {
