...
public interface WebServiceDeveloper extends Entity {
   Reference<? extends WebServiceDeveloper> getReference();

   class Deserializer extends ByTypeDeserializer<WebServiceDeveloper> {
        public Deserializer() {
