...
import org.openmetadatainitiative.openminds.latest.core.research.TissueSampleCollection;
import org.openmetadatainitiative.openminds.latest.core.research.TissueSampleState;
import org.openmetadatainitiative.openminds.latest.core.research.intf.TissueSampleAnatomicalLocation;
import org.openmetadatainitiative.openminds.latest.core.research.intf.TissueSampleOrigin;
import org.openmetadatainitiative.openminds.latest.core.research.intf.TissueSampleSpecies;


import static org.openmetadatainitiative.openminds.latest.core.research.TissueSample.SEMANTIC_NAME;
/**
...
public class TissueSample extends Instance implements org.openmetadatainitiative.openminds.latest.SANDS.atlas.intf.BrainAtlasVersionUsedSpecimen, org.openmetadatainitiative.openminds.latest.SANDS.atlas.intf.CommonCoordinateSpaceVersionUsedSpecimen, org.openmetadatainitiative.openminds.latest.core.products.intf.DatasetVersionStudiedSpecimen, org.openmetadatainitiative.openminds.latest.core.data.intf.FileBundleGroupedBy{
    ...
    public static Reference<TissueSample> createReference(InstanceId instanceId) {
    ...
    public class Builder implements org.openmetadatainitiative.openminds.utils.Builder<TissueSample>{
        ...
        public TissueSample build() {
            if (TissueSample.this.id == null) {
                TissueSample.this.id = new InstanceId(UUID.randomUUID().toString());
            }
            if(TissueSample.this.types == null || TissueSample.this.types.isEmpty() || !TissueSample.this.types.contains(SEMANTIC_NAME)){
                final List<String> oldValues = TissueSample.this.types;
                TissueSample.this.types = new ArrayList<>();
                TissueSample.this.types.add(SEMANTIC_NAME);
                if(oldValues != null){
                    TissueSample.this.types.addAll(oldValues);
                }
            }
