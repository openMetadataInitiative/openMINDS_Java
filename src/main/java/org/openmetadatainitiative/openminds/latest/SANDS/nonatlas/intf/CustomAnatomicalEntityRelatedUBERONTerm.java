...
public interface CustomAnatomicalEntityRelatedUBERONTerm extends Entity {
   ...
   class Deserializer extends ByTypeDeserializer<CustomAnatomicalEntityRelatedUBERONTerm> {
        public Deserializer() {
            super(org.openmetadatainitiative.openminds.latest.controlledTerms.Organ.class, org.openmetadatainitiative.openminds.latest.controlledTerms.UBERONParcellation.class);
        }
    }
}