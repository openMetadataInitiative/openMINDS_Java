...
public interface WorkflowRecipeDeveloper extends Entity {
   Reference<? extends WorkflowRecipeDeveloper> getReference();

   class Deserializer extends ByTypeDeserializer<WorkflowRecipeDeveloper> {
        public Deserializer() {
