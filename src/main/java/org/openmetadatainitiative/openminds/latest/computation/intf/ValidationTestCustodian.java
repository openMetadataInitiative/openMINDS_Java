 ...
 */
public interface ValidationTestCustodian extends Entity {
   Reference<? extends ValidationTestCustodian> getReference();

   class Deserializer extends ByTypeDeserializer<ValidationTestCustodian> {
        public Deserializer() {
