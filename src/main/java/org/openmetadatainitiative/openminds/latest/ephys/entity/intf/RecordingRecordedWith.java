package org.openmetadatainitiative.openminds.latest.ephys.entity.intf;
 ...
 */
public interface RecordingRecordedWith extends Entity {
   Reference<? extends RecordingRecordedWith> getReference();

   class Deserializer extends ByTypeDeserializer<RecordingRecordedWith> {
        public Deserializer() {
