...
public interface RecordingActivityDevice extends Entity {
   ...
   class Deserializer extends ByTypeDeserializer<RecordingActivityDevice> {
        public Deserializer() {
            super(org.openmetadatainitiative.openminds.latest.ephys.device.ElectrodeArrayUsage.class, org.openmetadatainitiative.openminds.latest.ephys.device.ElectrodeUsage.class, org.openmetadatainitiative.openminds.latest.ephys.device.PipetteUsage.class);
        }
    }
}