 ...
 */
public interface ElectrodeManufacturer extends Entity {
   Reference<? extends ElectrodeManufacturer> getReference();

   class Deserializer extends ByTypeDeserializer<ElectrodeManufacturer> {
        public Deserializer() {
