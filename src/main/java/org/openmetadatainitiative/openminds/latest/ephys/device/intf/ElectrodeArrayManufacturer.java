 ...
 */
public interface ElectrodeArrayManufacturer extends Entity {
   Reference<? extends ElectrodeArrayManufacturer> getReference();

   class Deserializer extends ByTypeDeserializer<ElectrodeArrayManufacturer> {
        public Deserializer() {
